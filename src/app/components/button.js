  ...
  return (
    <div className="font-sans">
      <button
        ...
        onClick={onClick}
      >
        <div className="transition duration-200 translate-x-[3px] translate-y-[3px] hover:translate-x-0 hover:translate-y-0 group-active:translate-x-[-1px] group-active:translate-y-[-1px]">{buttonBody}</div>
      </button>
    </div>
  );
}
