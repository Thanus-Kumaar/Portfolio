...
export default function footer() {
  return (
    <div className="w-full h-2/5 bg-primary-dark flex flex-row p-5">
      <div className="m-10 flex-1">
        <div className="w-[500px] bg-secondary-dark align-bottom rounded-lg h-full ml-36 text-xl flex flex-col justify-evenly px-5">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-row gap-4 justify-end">
          <div className="h-12 w-12 bg-secondary-dark group transition duration-200 rounded-md hover:scale-[1.1]">
        ...
        <div className="text-secondary-light text-5xl mt-7">A curious mind</div>
      </div>
    </div>
  );
}
